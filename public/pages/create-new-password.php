                            ...
                            <div class="card-body p-4 p-sm-5">
                                ...
                                <form method="POST" action="../../app/controllers/ResetPasswords.php" novalidate>
                                    ...
                                    <div class="form-floating mb-3">
                                        ...
                                        <input type="password" name="pwd" class="form-control" id="floatingInput" placeholder="Email">
                                        <label for="floatingInput">Enter a new password</label>
                                    </div>

                                    <div class="form-floating mb-3">
                                        <input type="password" name="pwd-repeat" class="form-control" id="floatingInput" placeholder="Email">
                                        <label for="floatingInput">Repeat a new password</label>
                                    </div>
                                    <!-- Button sign in -->
                                    <div class="d-grid">
